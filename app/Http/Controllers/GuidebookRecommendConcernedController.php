...
use App\GuidebookRecommendModel;
use Illuminate\Support\Facades\Storage;
use Illuminate\Http\File;
use Illuminate\Support\Facades\DB;

class GuidebookRecommendConcernedController extends Controller
{
    /**
    ...
    {
        $dc = GuidebookRecommendModel::all();
    ...
    public function store(Request $request)
    {
        ...
        GuidebookRecommendModel::create([
    ...
    {
        $dc = GuidebookRecommendModel::find($id);
    ...
    {
        if($request->id!=''){
            $dc = GuidebookRecommendModel::find($request->id);
            if($request->title_th!=''){
                $dc->title_th = $request->title_th;
            }
            if($request->title_en!=''){
