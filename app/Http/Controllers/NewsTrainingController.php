...
use App\NewsTrainingModel;
use Illuminate\Support\Facades\Storage;
use Illuminate\Http\File;
use Illuminate\Support\Facades\DB;

class NewsTrainingController extends Controller
{
    /**
    ...
    {
        if($request->id!=''){
            $nt = NewsTrainingModel::find($request->id);
            if($request->title_th!=''){
                $nt->title_th = $request->title_th;
            }
            if($request->title_en!=''){
